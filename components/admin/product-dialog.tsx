...
import { Product, Category, Warehouse } from "@prisma/client";
        ...
        <Dialog open={isDialogOpen} onOpenChange={handleOpenChange}>
            ...
            <DialogContent className="flex flex-col max-h-[90vh] sm:max-w-4xl p-0 overflow-hidden gap-0">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                    ...
                    <DialogFooter className="px-6 py-4 border-t bg-gray-50 sm:justify-between z-10">
